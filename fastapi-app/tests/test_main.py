...
# ── auto-generated: hello3 ──────────────────────────────────
class TestHello3:
    def test_hello3_returns_correct_string(self):
        from main import hello3
        result = hello3()
        assert result == "hello3"

    def test_hello3_return_type_is_str(self):
        from main import hello3
        result = hello3()
        assert isinstance(result, str)

    def test_hello3_does_not_return_none(self):
        from main import hello3
        result = hello3()
        assert result is not None

    def test_hello3_no_leading_or_trailing_whitespace(self):
        from main import hello3
        result = hello3()
        assert result == result.strip()

    def test_hello3_is_not_empty_string(self):
        from main import hello3
        result = hello3()
        assert len(result) > 0

    def test_hello3_called_multiple_times_returns_same_value(self):
        from main import hello3
        assert hello3() == hello3()

    def test_hello3_does_not_return_hello2(self):
        from main import hello3
        result = hello3()
        assert result != "hello2"

    def test_hello3_does_not_return_hello(self):
        from main import hello3
        result = hello3()
        assert result != "hello"

    def test_hello3_contains_hello_prefix(self):
        from main import hello3
        result = hello3()
        assert result.startswith("hello")

    def test_hello3_exact_length(self):
        from main import hello3
        result = hello3()
        assert len(result) == 6

    def test_hello3_ends_with_digit_3(self):
        from main import hello3
        result = hello3()
        assert result[-1] == "3"

    def test_hello3_is_lowercase(self):
        from main import hello3
        result = hello3()
        assert result == result.lower()

    def test_hello3_takes_no_arguments(self):
        from main import hello3
        import inspect
        sig = inspect.signature(hello3)
